...
Generated `2026-09-23T01:42:26Z` by `msl/docs.py`. Every figure here is read from the same
...
| Bytes read | 2,155,278 |
| Facts extracted | 731 |
| New claims | 731 |
| Claims rejected by the gate this cycle | 0 |
| Gate rejections in append-only history | 0 |
| Derived / rechecked / drifted | 392 / 2,294 / 0 |
| Topics (new) | 163 (6) |
| Insights published | 416 |
| Forecasts issued / scored | 1110 / 655 |
| Ideas (promoted) | 28 (1) |
